...
const Challenge = ({ challenge, onClick }: ChallengeProps) => {
  return (
    <div
      className={cn(
        'h-fit max-w-[calc(50%-12px)] min-w-[160px] flex-1 flex-col overflow-hidden rounded-xl bg-white shadow-lg',
    ...
    >
      ...
      <div className="flex flex-col gap-1 p-3 text-start">
        <span className="text-title-smaller text-sm font-bold">{challenge.name}</span>
