  ...
  const list = [
    {
      ...
      amount: 700,
      status: 'EARN', // "EARN" | "SPEND"
      transactionAt: '2025-07-12T08:43:38.908Z', // ISO 날짜 문자열
    },
    {
      ...
      amount: 500,
      status: 'EARN', // "EARN" | "SPEND"
      transactionAt: '2025-06-10T08:43:38.908Z', // ISO 날짜 문자열
    },
    {
      pointTransactionId: '1L',
      description: '친환경 텀블러 교환',
      amount: 700,
      status: 'SPEND', // "EARN" | "SPEND"
      transactionAt: '2025-06-05T08:43:38.908Z', // ISO 날짜 문자열
    },
    {
      pointTransactionId: '1L',
      ...
      amount: 800,
      status: 'EARN', // "EARN" | "SPEND"
      transactionAt: '2025-06-01T08:43:38.908Z', // ISO 날짜 문자열
    },
  ]
